...
const EpayPaymentButton = ({ invoice, onPaymentSuccess, style = {} }) => {
  ...
  const handlePaymentClick = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch('/api/payment/epay/direct-link', {
        method: 'POST',
        headers: {
      ...
      >
        <div style={{ textAlign: 'center', padding: '20px 0' }}>
          <div style={{ marginBottom: '20px' }}>
            ...
            <h3>Procesar Pago</h3>
            <p>Serás redirigido a la plataforma de pagos segura de ePay.co</p>
          </div>
...
export default EpayPaymentButton;
